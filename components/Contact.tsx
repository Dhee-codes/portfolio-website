...
export default function Contact() {
  ...
  return (
    <section id="contact" className="px-32 py-16 mb-40">
      <motion.h2
      ...
      <div className="grid grid-cols-2 gap-16">
        ...
        >
          ...
          <p className="text-lg tracking-wide mb-12">
            I&apos;m always open to new opportunities and collaborations. To discuss
            a project or simply network, please feel free to connect with me.
          </p>
          <ul className="flex gap-10 list-none">
            ...
            <li>
              <a
                ...
                target="_blank"
                rel="noopener noreferrer"
                className="text-[#c6c4cc] hover:text-[#d6ffff] transition-colors duration-300"
              >
                <svg
                  xmlns="http://www.w3.org/2000/svg"
                  width="32"
